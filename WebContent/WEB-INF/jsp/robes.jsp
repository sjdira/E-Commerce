                    ...
                    -->
                        <div class="row">
                            ...
                            Gamme de Prix(DH)
					            ...
					            <div class="form-group">
					              100 <input type="range" class="form-control-range" name="range"> 700
					            </div>
					           </form>
		                   </div>
                        </div>
						...
						<c:forEach items="${Articles}" var="article">
							...
							<div class="col-lg-3 mb-3 text-center">
								<div class="product-entry border">
									<a href="#" class="prod-img">
										<img src="<%=request.getContextPath()%>/ressources/images/item-5.jpg" class="img-fluid" alt="Free html5 bootstrap 4 template">
									</a>
									<div class="desc">
										<h2><a href="product-detail.jsp">Women's Boots Shoes Maca</a></h2>
										<span class="price">$139.00</span>
							...
							<div class="col-lg-3 mb-3 text-center">
								<div class="product-entry border">
									<a href="product-detail.jsp" class="prod-img">
										<img src="<%=request.getContextPath()%>/ressources/images/item-6.jpg" class="img-fluid" alt="Free html5 bootstrap 4 template">
									</a>
									<div class="desc">
							...
							<div class="col-lg-3 mb-3 text-center">
								<div class="product-entry border">
									<a href="product-detail.jsp" class="prod-img">
										<img src="<%=request.getContextPath()%>/ressources/images/item-8.jpg" class="img-fluid" alt="Free html5 bootstrap 4 template">
									</a>
									<div class="desc">
										<h2><a href="product-detail.jsp">Women's Boots Shoes Maca</a></h2>
										<span class="price">$139.00</span>
							...
							<div class="col-lg-3 mb-3 text-center">
								<div class="product-entry border">
									<a href="product-detail.jsp" class="prod-img">
										<img src="<%=request.getContextPath()%>/ressources/images/item-9.jpg" class="img-fluid" alt="Free html5 bootstrap 4 template">
									</a>
									<div class="desc">
										<h2><a href="product-detail.jsp">Women's Boots Shoes Maca</a></h2>
										<span class="price">$139.00</span>
							...
							<div class="col-lg-3 mb-3 text-center">
								<div class="product-entry border">
									<a href="product-detail.jsp" class="prod-img">
										<img src="<%=request.getContextPath()%>/ressources/images/item-10.jpg" class="img-fluid" alt="Free html5 bootstrap 4 template">
									</a>
									<div class="desc">
										<h2><a href="product-detail.jsp">Women's Boots Shoes Maca</a></h2>
										<span class="price">$139.00</span>
							...
							<div class="col-lg-3 mb-3 text-center">
								<div class="product-entry border">
									<a href="product-detail.jsp" class="prod-img">
										<img src="<%=request.getContextPath()%>/ressources/images/item-11.jpg" class="img-fluid" alt="Free html5 bootstrap 4 template">
									</a>
									<div class="desc">
										<h2><a href="product-detail.jsp">Women's Boots Shoes Maca</a></h2>
										<span class="price">$139.00</span>
							...
							<div class="col-lg-3 mb-3 text-center">
								<div class="product-entry border">
									<a href="product-detail.jsp" class="prod-img">
										<img src="<%=request.getContextPath()%>/ressources/images/item-12.jpg" class="img-fluid" alt="Free html5 bootstrap 4 template">
									</a>
									<div class="desc">
										<h2><a href="product-detail.jsp">Women's Boots Shoes Maca</a></h2>
										<span class="price">$139.00</span>
							...
							<div class="col-lg-3 mb-3 text-center">
								<div class="product-entry border">
									<a href="#" class="prod-img">
										<img src="<%=request.getContextPath()%>/ressources/images/item-13.jpg" class="img-fluid" alt="Free html5 bootstrap 4 template">
									</a>
									<div class="desc">
										<h2><a href="#">Women's Boots Shoes Maca</a></h2>
										<span class="price">$139.00</span>
							...
							<div class="col-lg-3 mb-3 text-center">
								<div class="product-entry border">
									<a href="#" class="prod-img">
										<img src="<%=request.getContextPath()%>/ressources/images/item-14.jpg" class="img-fluid" alt="Free html5 bootstrap 4 template">
									</a>
									<div class="desc">
										<h2><a href="#">Women's Boots Shoes Maca</a></h2>
										<span class="price">$139.00</span>
							...
							<div class="col-lg-3 mb-3 text-center">
								<div class="product-entry border">
									<a href="#" class="prod-img">
										<img src="<%=request.getContextPath()%>/ressources/images/item-15.jpg" class="img-fluid" alt="Free html5 bootstrap 4 template">
									</a>
									<div class="desc">
										<h2><a href="#">Women's Boots Shoes Maca</a></h2>
										<span class="price">$139.00</span>
