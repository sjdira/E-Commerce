   ...
   <link href="http://fonts.googleapis.com/css?family=Cookie" rel="stylesheet" type="text/css">
	...
	<div id="page">
		...
		<div class="breadcrumbs-two">
			<div class="container">
				<div class="row">
					<img src="<%=request.getContextPath()%>/ressources/images/1610099131dc272382dedc5e63157165dd35e4501a.gif" alt="promo"
		...
		<div class="breadcrumbs-two">
			<div class="container">
				<div class="row">
					<img src="<%=request.getContextPath()%>/ressources/images/16096750717b7d7e102f7afa216f27421a6a2ed75d.webp" alt="categoriers"
		...
		<div class="breadcrumbs-two">
			<div class="container">
				<div class="row">
					<img src="<%=request.getContextPath()%>/ressources/images/1610099368353004e2a5eee803a598bfe213558bb6 (1).gif" alt="promo"
					style="width: 100%; margin-top: 15px;">
				</div>
			</div>
		</div>
